...
class WorkExp extends React.Component {
    constructor(props) {
        ...
        this.state = {          
            workField:this.props.workExpDetails.workField , role:this.props.workExpDetails.role, monthsOfExp: this.props.workExpDetails.monthsOfExp, companyName: this.props.workExpDetails.companyName,
      ...
      onClickHandle = () =>{
          let details = {workField:this.state.workField , role:this.state.role, monthsOfExp: this.state.monthsOfExp, companyName: this.state.companyName,
      ...
      submitHandle = () => {
        let workDetails = {workField:this.state.workField , role:this.state.role, monthsOfExp: this.state.monthsOfExp, companyName: this.state.companyName,
          description: this.state.description,  workStart:this.state.workStart ,workEnd : this.state.workEnd  }
          //this.props.workExpPrev(details)

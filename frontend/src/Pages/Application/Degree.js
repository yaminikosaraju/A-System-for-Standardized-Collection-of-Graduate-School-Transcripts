...
class Degree extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
          ...
          country:this.props.degreeDetails.country,uniName:this.props.degreeDetails.uniName, uniRankWorld:this.props.degreeDetails.uniRankWorld,
            ...
            <div className = 'wrapper hideOverflow '>
                ...
                <Container className= 'studDiv ' >
                        ...
                        <Form.Label>Overall Grade</Form.Label>
                            <Form.Control as="input"  className="mr-sm-2" id="inlineFormCustomSelect"  value = {this.state.overallGrade}

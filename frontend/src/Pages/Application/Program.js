    ...
    constructor(props) {
      ...
      handleNext = (event) => {
          let details = {program: this.state.program,  
            ...
            overall:this.state.overall,analytical:this.state.analytical,
            quantitative:this.state.quantitative,verbalReasoning:this.state.verbalReasoning,
            ept:this.state.ept,eptOverall:this.state.eptOverall,eptSpeaking:this.state.eptSpeaking,
            ...
            <div className = 'wrapper hideOverflow '>
                <Container className= 'studDiv '>
                    ...
                    onChange={e => this.setState({ ept: e.target.value })}>
                                ...
                                <Form.Control as="input"  className="mr-sm-2" id="inlineFormCustomSelect" value={this.state.eptOverall}
                    onChange={e => this.setState({ eptOverall: e.target.value })}/>
                            </Form.Group>
                            <Form.Group as={Col} sm = {2} controlId="formProgram" >
                                <Form.Label>{this.state.ept} Writing Score</Form.Label>
                                <Form.Control as="input"  className="mr-sm-2" id="inlineFormCustomSelect" value={this.state.eptWriting}
                    onChange={e => this.setState({ eptWriting: e.target.value })}/>
                            </Form.Group>
                            <Form.Group as={Col} sm = {2} controlId="formProgram" >
                                <Form.Label>{this.state.ept} Speaking Score</Form.Label>
                                <Form.Control as="input"  className="mr-sm-2" id="inlineFormCustomSelect" value={this.state.eptSpeaking}
                    onChange={e => this.setState({ eptSpeaking: e.target.value })}/>
                            </Form.Group>
                            <Form.Group as={Col} sm = {2} controlId="formProgram" >
                                <Form.Label>{this.state.ept} Reading Score</Form.Label>
                                <Form.Control as="input"  className="mr-sm-2" id="inlineFormCustomSelect" value={this.state.eptReading}
                    onChange={e => this.setState({ eptReading: e.target.value })}/>
                            </Form.Group>
                            <Form.Group as={Col} sm = {2} controlId="formProgram" >
                                <Form.Label>{this.state.ept} Listening Score</Form.Label>
                                <Form.Control as="input"  className="mr-sm-2" id="inlineFormCustomSelect" value={this.state.eptListening}
